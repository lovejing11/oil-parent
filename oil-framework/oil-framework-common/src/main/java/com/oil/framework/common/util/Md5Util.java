...
public class Md5Util {
				...
				private static byte padding[] = { (byte) 0x80, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0,
				...
				public static String string2MD5(String inStr) {
								...
								try {
												inStr = new String(inStr.getBytes("UTF-8"), "iso8859-1");
								} catch (Exception _ex) {
