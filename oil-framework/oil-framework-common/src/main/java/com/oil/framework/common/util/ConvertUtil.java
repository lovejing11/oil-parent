...
public final class ConvertUtil {
     ...
     * 2) 字符串的"1"、"0"值会转化为boolean类型的true、fasle值；
     * 3) value为null或者空字符串，会返回defaultValue；
     * 4) 除以上情况外，均返回true值；
     ...
     * 转换不成功时返回defaultValue并记录info或者warn日志，不会抛出任何异常。
     * 
     * 1) value等于null时，返回defaultValue；
     * 2) value为{@link Boolean}类型时，不进行类型转换，直接返回value值；
     * 3) value为{@link String}类型时，参考{@link #toBool(String, Boolean)}；
     * 4) value为{@link Byte}、{@link Short}、{@link Integer}、{@link Long}、{@link Float}、
     *           {@link Double}、{@link BigDecimal}、{@link BigInteger}
     *           等类型时，值为0返回false，否则返回true；
     ...
     * 2) value为{@link Integer}类型时，不进行类型转换，直接返回value值；
     * 3) value为{@link String}类型时，参考{@link #toInt(String, Integer)}；
     * 4) value为{@link Byte}、{@link Short}、{@link Long}、{@link Float}、{@link Double}、
    ...
    public static Integer toInt(Object value, Integer defaultValue) {
        ...
        log.warn("Can not convert " + cls.getName() + " to Integer, use default value: "
                 + defaultValue);
        return defaultValue;
    }
    ...
    public static Long toLong(String value, Long defaultValue) {
        ...
        if (value.indexOf('.') >= 0) {
            try {
                ...
                log.warn("Can not convert \"" + value + "\" to Long, use default value: "
                         + defaultValue, e);
                return defaultValue;
            }
        }
     ...
     * <p>
     * 1) value等于null时返回defaultValue；
     * 2) value为{@link Long}类型时，不进行类型转换，直接返回value值；
     * 3) value为{@link String}类型时，参考{@link #toLong(String, Long)}；
    ...
    public static Long toLong(Object value, Long defaultValue) {
        ...
        log.warn("Can not convert " + cls.getName() + " to Long, use default value: "
                 + defaultValue);
        return defaultValue;
    }
    ...
    public static Float toFloat(String value, Float defaultValue) {
        ...
        try {
            ...
            log.warn("Can not convert \"" + value + "\" to Float, use default value: "
                     + defaultValue, e);
            return defaultValue;
        }
    }
     ...
     * <p>
     * 1) value等于null时返回defaultValue；
     * 2) value为{@link Float}类型时，不进行类型转换，直接返回value值；
     * 3) value为{@link String}类型时，参考{@link #toFloat(String, Float)}；
    ...
    public static Float toFloat(Object value, Float defaultValue) {
        ...
        log.warn("Can not convert " + cls.getName() + " to Float, use default value: "
                 + defaultValue);
        return defaultValue;
    }
    ...
    public static Double toDouble(String value, Double defaultValue) {
        ...
        try {
            ...
            log.warn("Can not convert \"" + value + "\" to Double, use default value: "
                     + defaultValue, e);
            return defaultValue;
        }
    }
     ...
     * <p>
     * 1) value等于null时返回defaultValue；
     * 2) value为{@link Double}类型时，不进行类型转换，直接返回value对象；
     * 3) value为{@link String}类型时，参考{@link #toDouble(String, Double)}；
     * 4) value为{@link Byte}、{@link Short}、{@link Integer}、{@link Long}、
    ...
    public static Double toDouble(Object value, Double defaultValue) {
        ...
        log.warn("Can not convert " + cls.getName() + " to Double, use default value: "
                 + defaultValue);
        return defaultValue;
    }
     ...
     * <p>
     * 1) value等于null时返回defaultValue；
     * 2) value为{@link BigDecimal}类型时，不进行类型转换，直接返回value对象；
     * 3) value为{@link String}类型时，参考{@link #toDecimal(String, BigDecimal)}；
     * 4) value为{@link Byte}、{@link Short}、{@link Integer}、{@link Long}、{@link Float}、{@link Double}、{@link BigInteger}
